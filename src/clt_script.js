...
(() => {
            ...
            (a = [
                {
                    ...
                    value: function () {
                        ...
                        var e = function (e, t, n, a, o) {
                                var r;
                                if (((r = "eliminar" != e && o.includes("*") ? o.replace(/(\*)/g, "_") : o), window.confirm(n))) {
                                    a.style.display = "inline";
                                    var i = "action=proces&upcomingStatus=".concat(e, "&id=").concat(t, "&email=").concat(r);
                                    jQuery.ajax({
                                        type: "post",
                            ...
                            t = function (e) {
                                return "proceso" === e
                                    ? "Está cambiando el estado de este pedido a modo. En Proceso! El usuario recibirá un email con esta confirmacion. acepte para confirmar!"
                                    : "envio" === e
                                    ? "Está cambiando el estado del envio del pedido a estado, En Enviado! El usuario recibirá un email con esta confirmacion. acepte para confirmar!"
                                    : "eliminar" === e
                                    ? "Con esta acción, eliminará los datos de este usuario, estos datos no son recuperables, acepte si desea continuar!"
                                    : null;
                            };
                    },
                },
    ...
    var n = document.getElementById("conditionalSubmit"),
        ...
        r = ["ouputCltHost", "ouputCltPort", "ouputCltSecure", "ouputCltemail", "ouputCltPass"],
        ...
        return (
            ...
            (a = [
                ...
                },
                {
                    ...
                    value: function () {
                        for (var e = [], t = 0; t < o.length; t++) e.push(document.getElementsByName(o[t])[0]);
                        var n = e
                                .filter(function (e) {
                                    return "" != e.value;
                                })
            ...
            (n = [
                {
                    ...
                    value: function (e) {
                        var t = e.split("_")[1];
                        window.confirm("Esta a punto de borrar este reporte con id: ".concat(t, ", está seguro?")) &&
                            jQuery.ajax({
                                type: "post",
                                url: ajax_variables.ajax_url,
                                dataType: "text",
    ...
    window.onload = function () {
        (window.processaction = new t()),
            (window.processConditional = new l()),
