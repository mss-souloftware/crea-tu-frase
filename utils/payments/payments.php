...
<div style="display:none;" class="chocoletrasPlg__wrapperCode-payment-buttons-left">
    ...
    define('RETURN_URL', "$plugin_page?payment=true&payerID=" . $getOrderData['uoi'] . "");
    define('CANCEL_URL', $plugin_payment);
    define('NOTIFY_URL', "$thank_you_page?payment=true&payerID=" . $getOrderData['uoi'] . "");
    ...
    $miObj->setParameter("DS_MERCHANT_URLOK", "$plugin_payment?payment=true&payerID=" . $getOrderData['uoi']);
...
<div style="display:none;" class="chocoletrasPlg__wrapperCode-payment-buttons-left">
    ...
    $bizumObj->setParameter("DS_MERCHANT_URLOK", "$plugin_payment?payment=true&payerID=" . $getOrderData['uoi']);
