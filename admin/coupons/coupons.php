        ...
        <form method="post" action="">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td><input type="number" name="coupon_usage_limit" /></td>
                </tr>
            </table>
                ...
                <?php if (!empty($coupons)) : ?>
                    <?php foreach ($coupons as $index => $coupon) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo add_query_arg(['action' => 'delete', 'index' => $index]); ?>" onclick="return confirm('Are you sure you want to delete this coupon?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
